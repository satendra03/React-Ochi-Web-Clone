...
function PrivacyPolicy() {
  return (
    <>
      <div class="page w-full px-20 text-xl leading-relaxed">
        <div class="header">
          <div class="container">
            <p class="title">Privacy Policy for Satendra - Portfolio</p>
          </div>
        </div>
              ...
              <ul>
                ...
                <li>
                  <p>
                    ...
                    Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                    &quot;Our&quot; in this Agreement) refers to Satendra -
                    Portfolio.
                  </p>
                </li>
                <li>
                ...
                <li>
                  <p>
                    <strong>Website</strong> refers to Satendra - Portfolio,
                    accessible from{" "}
                    <a
                      href="www.satendra03.github.io/portfolio"
                      rel="external nofollow noopener"
                      target="_blank"
                    >
                      www.satendra03.github.io/portfolio
                    </a>
                  </p>
                </li>
                <li>
              ...
              <ul>
                <li>
                  ...
                  <a
                    ...
                    class="__cf_email__"
                    data-cfemail="b6c4d7d8d2d9dbf6dbd7dfda98d5d9db"
                  >
                    [email&#160;protected]
                  </a>
                </li>
